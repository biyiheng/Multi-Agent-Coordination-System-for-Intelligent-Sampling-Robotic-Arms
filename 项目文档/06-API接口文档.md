...
| v2.3.0 | 2026-08-19 | 项目 v1.2 更新：统一帧格式通信协议（CRC16 校验）、遥测推送 20Hz、实时安全传感器过载监控（温度/电流）、Vision/Sampling Agent 增强、模型重训练 Round 12（详见 20-更新报告v1.2.md） | 项目组 |
| v2.2.0 | 2026-08-15 | 项目 v1.1 更新：补充样本 / 闭环工程（评估报告/性能画像/交互日志/技能/知识血缘/元技能）CRUD 接口、系统配置单项读写删除、配置备份恢复接口 | 项目组 |